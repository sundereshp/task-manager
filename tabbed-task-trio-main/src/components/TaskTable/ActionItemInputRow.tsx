    ...
    <tr className="hover:bg-gray-50">
      <td className="py-1">
        <div className="flex items-center w-full">
          <div className="w-24 flex-shrink-0"></div> {/* Increased indentation for action items */}
          <div className="min-w-0 flex-1 pl-2">
            <div className="max-w-2xl">
              <Input
                ...
                className="w-full border-0 shadow-none focus-visible:ring-0 pl-8 py-1 text-sm h-8"
              />
            </div>
          </div>
        </div>
